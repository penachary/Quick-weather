...
const countrucode = async function(){
  try{
      ...
      const res = await fetch("https://api.open-meteo.com/v1/forecast?latitude=41.02&longitude=28.96&daily=weathercode,temperature_2m_max,temperature_2m_min,apparent_temperature_max,apparent_temperature_min,sunrise,sunset,precipitation_sum,precipitation_hours,windspeed_10m_max,windgusts_10m_max,winddirection_10m_dominant,shortwave_radiation_sum&timezone=Europe%2FBerlin");
...
const wheather = async function(){
  try{
      const res = await fetch("http://api.positionstack.com/v1/forward?access_key=1ecc74fc50e4b04c284b0b718ca84c6d&query=moscow");
